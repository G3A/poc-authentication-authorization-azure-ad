...
class OpenApiConfiguration {
    ...
    WebSecurityCustomizer webSecurityCustomizer() {
        return (web) -> web.ignoring().requestMatchers("/", "/swagger-ui.html", "/swagger-ui/**", "/v3/api-docs", "/v3/api-docs/**");
    }
    ...
    OpenAPI customOpenAPI() {
        ...
        authorizationCodeFlow.setScopes(new Scopes()
            .addString(properties.getAppIdUri() +"/.default", "Read 2")
